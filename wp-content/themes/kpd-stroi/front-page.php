			...
			<div class="tab-contents">
				...
				<div class="tab-content active" data-tab="small">
					...
					<div class="name-image">
						<h3>Стандарт</h3>
						<a href="<?php echo $template_url; ?>/img/houses/standart_1/1.jpg" class="image fancybox" style="background: url(<?php echo $template_url; ?>/img/houses/standart_1/1.jpg) center; background-size: cover;" data-fancybox="house-standart_1"></a>
					</div>

					<div class="d-none">
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_1/2.jpg" data-fancybox="house-standart_1" data-thumb="<?php echo $template_url; ?>/img/houses/standart_1/2.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_1/3.jpg" data-fancybox="house-standart_1" data-thumb="<?php echo $template_url; ?>/img/houses/standart_1/3.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_1/4.jpg" data-fancybox="house-standart_1" data-thumb="<?php echo $template_url; ?>/img/houses/standart_1/4.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_1/5.jpg" data-fancybox="house-standart_1" data-thumb="<?php echo $template_url; ?>/img/houses/standart_1/5.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_1/scheme.jpg" data-fancybox="house-standart_1" data-thumb="<?php echo $template_url; ?>/img/houses/standart_1/scheme.jpg"></a>
					</div>
					...
					<div class="text">
						...
						<ul>
							...
							<li>Закрытая огроженная территория <br>(общий забор)</li>
							<li>Гарантия 50 лет!</li>
						</ul>
						<p>Коттедж для тех, кто ценит простоту и практичность. Архитектура дома - без лишних деталей. Жители коттеджа “Стандарт”  получат ощущение теплоты, комфорта и защищенности на долгие годы. А мансардный этаж позволит воплотить самые смелые эксперименты в области дизайна интерьера.</p>
				...
				<div class="tab-content" data-tab="medium">
					...
					<div class="name-image">
						<h3>Стандарт</h3>
						<a href="<?php echo $template_url; ?>/img/houses/standart_2/1.jpg" class="image fancybox" style="background: url(<?php echo $template_url; ?>/img/houses/standart_2/1.jpg) center; background-size: cover;" data-fancybox="house-standart_2"></a>
					</div>

					<div class="d-none">
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_2/2.jpg" data-fancybox="house-standart_2" data-thumb="<?php echo $template_url; ?>/img/houses/standart_2/2.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_2/3.jpg" data-fancybox="house-standart_2" data-thumb="<?php echo $template_url; ?>/img/houses/standart_2/3.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_2/4.jpg" data-fancybox="house-standart_2" data-thumb="<?php echo $template_url; ?>/img/houses/standart_2/4.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_2/5.jpg" data-fancybox="house-standart_2" data-thumb="<?php echo $template_url; ?>/img/houses/standart_2/5.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_2/scheme.jpg" data-fancybox="house-standart_2" data-thumb="<?php echo $template_url; ?>/img/houses/standart_2/scheme.jpg"></a>
					</div>
				...
				<div class="tab-content" data-tab="big">
					...
					<div class="name-image">
						<h3>Стандарт</h3>
						<a href="<?php echo $template_url; ?>/img/houses/standart_3/1.jpg" class="image fancybox" style="background: url(<?php echo $template_url; ?>/img/houses/standart_3/1.jpg) center; background-size: cover;" data-fancybox="house-standart_3"></a>
					</div>

					<div class="d-none">
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_3/2.jpg" data-fancybox="house-standart_3" data-thumb="<?php echo $template_url; ?>/img/houses/standart_3/2.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_3/3.jpg" data-fancybox="house-standart_3" data-thumb="<?php echo $template_url; ?>/img/houses/standart_3/3.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_3/4.jpg" data-fancybox="house-standart_3" data-thumb="<?php echo $template_url; ?>/img/houses/standart_3/4.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_3/5.jpg" data-fancybox="house-standart_3" data-thumb="<?php echo $template_url; ?>/img/houses/standart_3/5.jpg"></a>
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/standart_3/scheme.jpg" data-fancybox="house-standart_3" data-thumb="<?php echo $template_url; ?>/img/houses/standart_3/scheme.jpg"></a>
					</div>
					...
					<div class="text">
						...
						<p>Коттедж для тех, кто ценит простоту и практичность. Архитектура дома - без лишних деталей. Жители коттеджа “Стандарт”  получат ощущение теплоты, комфорта и защищенности на долгие годы. А мансардный этаж позволит воплотить самые смелые эксперименты в области дизайна интерьера.</p>
						<h2>Стоимость: 6.37 <small>млн. ₽</small></h2>
					</div>
				</div>
		...
		<div class="tabs houses reverse-sm">
				<div class="tab-contents">
					...
					<div class="tab-content active" data-tab="small">
						...
						<div class="name-image">
							<h3>Классика</h3>
							<a href="<?php echo $template_url; ?>/img/houses/classic_1/1.jpg" class="image fancybox" style="background: url(<?php echo $template_url; ?>/img/houses/classic_1/1.jpg) center; background-size: cover;" data-fancybox="house-classic_1_sm"></a>
						</div>
					...
					<div class="tab-content" data-tab="medium">
						...
						<div class="name-image">
							<h3>Классика</h3>
							<a href="<?php echo $template_url; ?>/img/houses/classic_2/1.jpg" class="image fancybox" style="background: url(<?php echo $template_url; ?>/img/houses/classic_2/1.jpg) center; background-size: cover;" data-fancybox="house-classic_2_sm"></a>
						</div>
					...
					<div class="tab-content" data-tab="big">
						...
						<div class="name-image">
							<h3>Классика</h3>
							<a href="<?php echo $template_url; ?>/img/houses/classic_3/1.jpg" class="image fancybox" style="background: url(<?php echo $template_url; ?>/img/houses/classic_3/1.jpg) center; background-size: cover;" data-fancybox="house-classic_3_sm"></a>
						</div>
...
<section class="houses-section last" id="our-homes">
	<div class="container">
		...
		<div class="tabs houses">
			...
			<div class="tab-contents">
				...
				<div class="tab-content active" data-tab="small">
					...
					<div class="name-image">
						<h3>Техас</h3>
						<a href="<?php echo $template_url; ?>/img/houses/texas_1/1.jpg" class="image fancybox" style="background: url(<?php echo $template_url; ?>/img/houses/texas_1/1.jpg) center; background-size: cover;" data-fancybox="house-texas"></a>
					</div>

					<div class="d-none">
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/texas_1/scheme.jpg" data-fancybox="house-texas" data-thumb="<?php echo $template_url; ?>/img/houses/texas_1/scheme.jpg"></a>
					</div>

					<div class="text">
						<h2>Дом 6х8</h2>
						<h3>Общая площадь 126,53 м<sup><small>2</small></sup></h3>
						<ul>
							<li>Каменный надежный дом</li>
							<li>Центральная вода</li>
							<li>Шамбо 10 м<sup><small>3</small></sup></li>
						...
						<p>Предложение для тех, кто ценит нестандартный подход к организации внутреннего пространства и отделки. Отличительной особенностью этого коттеджа является великолепная терраса глубиной 1,5 метра. Вы мечтаете о душевных завтраках и семейных обедах на свежем воздухе? Перед вами готовое решение. Отдельного внимания заслуживает мансардный этаж - именно он придаёт дому выразительный внешний и внутренний вид.</p>
						<h2>Стоимость: 5.35 <small>млн. ₽</small></h2>
					</div>
				...
				<div class="tab-content" data-tab="medium">
					...
					<div class="name-image">
						<h3>Техас</h3>
						<a href="<?php echo $template_url; ?>/img/houses/texas_2/1.jpg" class="image fancybox" style="background: url(<?php echo $template_url; ?>/img/houses/texas_2/1.jpg) center; background-size: cover;" data-fancybox="house-texas_2"></a>
					</div>

					<div class="d-none">
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/texas_2/scheme.jpg" data-fancybox="house-texas_2" data-thumb="<?php echo $template_url; ?>/img/houses/texas_2/scheme.jpg"></a>
					</div>

					<div class="text">
						<h2>Дом 8х8</h2>
						<h3>Общая площадь = 158,68 м<sup><small>2</small></sup></h3>
						<ul>
							<li>Каменный надежный дом</li>
							<li>Центральная вода</li>
							<li>Шамбо 10 м<sup><small>3</small></sup></li>
				...
				<div class="tab-content" data-tab="big">
					...
					<div class="name-image">
						<h3>Техас</h3>
						<a href="<?php echo $template_url; ?>/img/houses/texas_3/1.jpg" class="image fancybox" style="background: url(<?php echo $template_url; ?>/img/houses/texas_3/1.jpg) center; background-size: cover;" data-fancybox="house-texas_3"></a>
					</div>

					<div class="d-none">
						<a class="image fancybox" href="<?php echo $template_url; ?>/img/houses/texas_3/scheme.jpg" data-fancybox="house-texas_3" data-thumb="<?php echo $template_url; ?>/img/houses/texas_3/scheme.jpg"></a>
					</div>

					<div class="text">
						<h2>Дом 8х10</h2>
						<h3>Общая площадь = 191,21 м<sup><small>2</small></sup></h3>
						<ul>
							<li>Каменный надежный дом</li>
							<li>Центральная вода</li>
							<li>Шамбо 10 м<sup><small>3</small></sup></li>
		...
		<a href="#take-information" class="button ripplelink open-form-button">Хочу дом!</a>
